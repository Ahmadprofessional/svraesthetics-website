    ...
    sections: [
      { heading: "Who we are", paragraphs: ["SVR Aesthetics is an aesthetic clinic located at Unit 2, Stainer Square Centre, Queensway, Bletchley, Milton Keynes, MK2 2FY. We are the data controller for the personal information described in this policy. You can contact us about privacy matters by email at svraesthetics@gmail.com or by phone on 077 92284575."] },
      {
        ...
        bullets: [
          ...
          "Calls to our AI Booking Assistant (+44 7455 757309) — these calls may be recorded and automatically transcribed so the assistant can understand your request and book your appointment.",
          "Messages you send to the AI chat assistant on our website — your typed messages and the assistant's replies, for the duration of that chat session only (not stored after you leave the page).",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Our AI booking and chat assistant providers, who process call recordings, transcripts and chat messages using artificial intelligence (including voice AI platform Vapi and underlying AI language models) solely to understand your request and help you book an appointment.",
          "Regulators, insurers or legal advisers where we are required to do so by law or to defend a claim.",
        ],
      },
      {
        heading: "Our AI booking assistant and chat assistant",
        paragraphs: [
          "To make booking easier, we offer an AI Booking Assistant you can call on +44 7455 757309, and an AI chat assistant on our website. These are provided to help you check availability and book a consultation, and to answer general questions about our treatments, pricing and opening hours.",
          "Calls to the AI Booking Assistant may be recorded and transcribed so the assistant can process your request; recordings and transcripts are processed by our voice AI provider and used only to handle your booking. Messages you type into the website chat assistant are sent to our AI provider to generate a reply and are not stored beyond your browsing session.",
          "Please do not share sensitive medical information (such as your medical history or medication details) with either AI assistant — this is collected securely during your free consultation with Sonali instead. Neither AI assistant makes clinical decisions or provides medical advice.",
        ],
      },
