...
export const landingPages: LandingPageData[] = [
  {
    ...
    metaTitle: "Dermal Fillers Milton Keynes — From £100, Up to 25% Off First Treatment | SVR Aesthetics",
    ...
    offer: "Up to 25% off your first treatment",
  ...
  },
  {
    ...
    offer: "Up to 25% off your first facial",
